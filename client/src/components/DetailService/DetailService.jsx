    ...
    return (
      ...
      <Box display="grid" 
        ...
        <Box gridColumn="span 4" m={2} p={2} border="solid 1px lightgrey">
          <Box gridColumn="span 12" display="flex" flexDirection="row" justifyContent="space-between">
          ...
          <Box gridColumn="span 12" display="flex" flexDirection="row" flexWrap="wrap" alignContent="start">
              <Typography variant="h5" sx={{width: "100%", textAlign: "left"}}> {title} </Typography>
              <Rating
                name="read-only"
                value={rating}
                precision={0.5}
          ...
          <Box gridColumn="span 12">
            ...
            <Typography variant="subtitle2" component="div" sx={{textAlign: "left"}}> {description} </Typography>
          </Box>
        </Box>
      </Box>  
    )
