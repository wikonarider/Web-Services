...
const musica = [
  {
    ...
    En las clases se trabaja una técnica, y teoría musical, en función al gusto musical que le interesa a cada alumno: ya sea con púa o dedos,guitarra clásica o eléctrica. En diversos géneros, se desarrollará una técnica funcional (y personal) para cada uno.
  ...
  },
  {
    ...
    Posición para tocarlos.
    
    Nomenclatura musical.
    
    Diferentes tipos de golpes:
    
    Tono abierto, tono apagado, tono bajo, galleta, golpe de aro apagado (martillo),
    
    rulo con ambas manos, apoyatura.
    
    Lectura por música.
    
    Diferentes figuraciones:
    
    Quintillo, doble tiempo, tresillo de semicorcheas, tresillo de negras.
    
    Métricas:
    
    Métricas impares: 5/8, 7/8, 11/8, 13/8 y zórcico 10/8.
    
    Métricas compuestas: 6/8, 9/8, 12/8.
    
    Diferentes estilos:
    
    Brasileños, salsa, candombe, guaguancó, bomba, cumbia, mazacote, guaracha,
    
    merengue, columbia, conga cubana, afrocubano, etc.
    
    Rellenos para tiempos lentos.
    
    Método de paradidles y sus técnicas de Daniel Mele.
    
    Método de acentuaciones de C: Wilcoxon.
    
    Análisis, estudio y lectura de partituras.
    
    Ritmos acompañando música grabada.
...
const teatro = [
  ...
  },
  {
    ...
    Desde el 13 de octubre, todos los miercoles a las 19:30hs, hasta las 20:30, en nuestro querido Club Atlético Central Argentino! 
     Son 8 clases en las que, a traves del juego, empezamos a trabajar la confianza (en uno y en los compañeros), el soltarse, reírse de uno mismo y mientras tanto incorporamos nociones de actuación, expresión corporal y pantomima. Desde el 13 de octubre, todos los miercoles a las 19:30hs, hasta las 20:30.
    La primera clase es gratuita y luego $200 por alumno por clase. Si te quedaron dudas consultame!
...
const academia = [
  {
    ...
    Publicación Maestría Doctoral
    
    Tenemos TU SOLUCION! profesionales
    
    profesores, expertos te ayudamos con tu TESIS De grado , Posgrado Doctoral
    
    HACEMOS EXITOSA TU TESIS
    
    Profesionales al servicio DE LO QUE NECESITAS! TE AYUDAMOS A CONCRETARLO! ASESORIA DE TESIS REDACCION CORRECCION
  ...
  },
  {
    ...
    Corrijo sin cargo cualquier observación.
...
const otros = [
  ...
  },
  {
    ...
    MARTES DE 20 A 22 COMIENZA EL 2 DE NOVIEMBRE
    
    PRESENCIAL/PROTOCOLOS SANITARIOS APROBADOS/PARA INFORMES E INSCRIPCIÓN LLAMAR DELIA O DEJAR UN CELULAR Y ME COMUNICO
    
    CLASE 1;SEGURIDAD, HIGIENE Y CUIDADOS: Presentación del curso y alumno/Lugar de trabajo/Seguridad legal/primeros auxilios/Composición y armado del área de trabajo/ Armado de máquina/ Seguridad e higiene (infecciones directas y cruzadas)/ Desarmado del área de trabajo/Cuidados del tatuaje
    
    CLASE 2;DISEÑO Y STENCIL
    
    Armado y análisis del diseño/ Realización del stencil/Práctica:esténcil sobre piel sintética
    
    CLASE 3; MÁQUINAS
    
    Tipos de máquinas (rotativas y electromagnéticas)/ Práctica,
    
    Partes que componen una máquina
    
    Comparativa de máquinas rotativas y electromagnéticas, ventajas y desventajas/Calibrado de máquinas electromagnéticas/ Fuente de alimentación/ Agujas y punteras/Eterización
    
    CLASE 4;TINTAS (TIPOS, USOS, CUIDADOS, VENTAJAS Y DESVENTAJAS)
    
    Conocimiento de los distintos tipos de tintas/ Diluir pigmentos/ Crear nuevos tonos de pigmentos/ Práctico; Conocimiento de pigmentos negro y color, diluir los mismos, componer nuevos colores
    
    CLASE 5; DELINEADO
    
    Teoría del delineado
    
    Teoría de lubricación, estiramiento y limpieza de la zona que se está tatuando/Práctico aplicación de lo teórico sobre piel sintética
    
    CLASE 6; RELLENO Y SOMBRA (RELLENO, NEGRO, COLOR Y SOMBRAS)
    
    Teoría del relleno/Teoría del sombreado/ Práctico; aplicación de lo teórico sobre piel sintética
    
    CLASES 7 Y 8;BLACKundefinedGREY (ESCALAS GREYEASH, USOS, VENTAJAS Y DESVENTAJAS)
    
    Teoría del BlackundefinedGrey
    
    Conocimientos de la técnica mediante imágenes de artistas reconocidos
    
    Práctic; Aplicación de lo teórico sobre piel sintética
    
    Realizar Stencil de un diseño de BlackundefinedGrey simple, transferido a piel sintética y aplicar la técnica aprendida
    
    CLASES 9 Y 10; BLACKWORK, PUNTILLISMO, Y WATERCOLOR (ACUARELA)
    
    Teoría del Blackwork y de puntillismo/Conocimiento de la técnica/mediante imágenes de artistas reconocidos/ Práctico; Aplicación de lo teórico sobre piel sintética/ Realizar Stencil de un diseño tradicional simple, transferido a piel sintética y aplicar la técnica aprendida
    
    CLASES 11 A 12; GEOMETRÍA, ORNAMENTOS Y LETTERING
    
    Teoría del tatuaje geometría, ornamentos y lettering
    
    Conocimiento de la técnica mediante imágenes de artistas reconocidos/ Práctico; ejercicios de aplicación de lo teórico sobre piel sintética/Realizar Stencil de un diseño simple sobre piel sintética con la técnica aprendida
    
    CLASES 13 Y 14;TATUAJE TRADICIONAL (OLD SCHOOL)
    
    Teoría del tatuaje tradicional/Conocimiento de la técnica mediante imágenes de artistas reconocidos/ Práctico; Aplicación de lo teórico sobre piel sintética/ Realizar Stencil de un diseño tradicional simple, transferido a piel sintética con la técnica aprendida
    
    CLASES 15 A 16; TATUAJE NEOTRADICIONAL (NEW SCHOOL)Teoría del tatuaje neotradicional/Conocimiento de la técnica mediante imágenes de artistas reconocidos/ Práctico; Aplicación de lo teórico sobre piel sintética/ Realizar Stencil de un diseño neotradicional simple
    
    CLASES 17 Y 18TATUAJE ORIENTAL (IREZUMI)
    
    Teoría del tatuaje oriental/Conocimiento de la técnica mediante imágenes de artistas reconocidos/ Práctico; Aplicación de lo teórico sobre piel sintética/ Realizar Stencil de un diseño tradicional simple, transferido a piel sintética con la técnica aprendida
    
    CLASES 19 Y 20;TATUAJE TRIBAL (MAORI, CELTA, SAMOANOS Y MODERNOS)
    
    Teoría del tatuaje tribal/Conocimiento de la técnica mediante imágenes de artistas reconocidos/ Práctico; Aplicación de lo teórico sobre piel sintética
    
    CLASES 21 Y 22;TRASHPOLKA, SURREALISMO, REALISMO Y BOCETO
    
    Teoría del tatuaje trashpolka, surrealismo y boceto/Conocimiento de la técnica mediante imágenes de artistas reconocidos/Práctico/Realizar Stencil de un diseño tradicional simple, transferido a piel sintética con la técnica aprendida
